  ...
  return (
    <div className="productdisplay">
      ...
      <div className="productdisplay-right">
        ...
        <button onClick={()=>addToCart(product.id)}>Kartga qo'shish</button>
        <p className="productdisplay-right-category"><span>Turkum :</span> Umumiy tarif </p>
        <p className="productdisplay-right-category"><span>Teglar :</span> Zamonaviy, so'ngi</p>
      </div>
    </div>
  );
};
